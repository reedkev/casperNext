...
/**
 * This is the model class for table "qst_match_up".
 *
 * The followings are the available columns in table 'qst_match_up':
 * @property integer $id
 * @property string $question_text
 *
 * The followings are the available model relations:
 * @property MatchUpChoices[] $matchUpChoices
 */
class MatchUp extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'matchUpChoices' => array(self::HAS_MANY, 'MatchUpChoices', 'match_up_id'),
		);
	}
