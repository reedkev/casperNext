<div class="navbar navbar-inverse navbar-fixed-top clearfix">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="#">CASPer <small>next generation testing</small></a>
            ...
            if(Yii::app()->user->isGuest)
            {
              ...
              $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
                        ...
                        array('label'=>'Features', 'url'=>array('/site/index')),
                        array('label'=>'Pricing', 'url'=>array('/site/index')),
                        array('label'=>'Sign Up', 'url'=>array('/site/index')),
                        array('label'=>'Contact', 'url'=>array('/site/index')),
                    ...
                    'items'=>array(
                      ...
                      //  array('label'=>'Typography', 'url'=>array('/site/page', 'view'=>'typography')),
                        ...
                        array('label'=>'My Account <span class="caret"></span>', 'url'=>'#','itemOptions'=>array('class'=>'dropdown','tabindex'=>"-1"),'linkOptions'=>array('class'=>'dropdown-toggle','data-toggle'=>"dropdown"), 
                            'items'=>array(
                            array('label'=>'My Info', 'url'=>'#'),   //<span class="badge badge-warning pull-right">26</span>
...
<div class="subnav navbar navbar-fixed-top clearfix">
    <div class="navbar-inner">
    	<div class="container">
        	...
        	<div class="style-switcher pull-left">
                ...
                <a href="javascript:chooseStyle('style4', 60)" checked="checked"><span class="style" style="background-color:#4e4e4e;"></span></a>
