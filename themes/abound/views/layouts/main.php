...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>CASPer - a next generation user testing platform</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Free yii themes, free web application theme">
    <meta name="description" content="CASPer is a secure video testing tool built for educational admissions testing.">
    <meta name="keywords" content="video, testing, admissions">
    <meta name="robots" content="index, follow">
    <meta name="copyright" content="&copy; McMaster University">
  ...
  <?php  
      ...
      <!-- styles for style switcher -->
        ...
        <link rel="alternate stylesheet" type="text/css" media="screen" title="style1" href="<?php echo $baseUrl;?>/css/style-blue.css" />
